...
urlpatterns = [#为每一个路径都设置一个设置一个名字到最后直接在前端传参数的时候直接调用名字即可避免直接编码
    path('', views.index, name='index'),  # 默认直接进入index主页
    path('C/', views.C, name='C'),  # C语言专题
    path('Java/', views.Java, name='Java'),
    path('python/', views.python, name='python'),
    path('Cjj/', views.Cjj, name='C++'),
    ...
    path('back/', views.back, name='back'),  # 课程软件库文章
    path('test/',views.test,name='test'),#分类
    # path(r'download/$',views.back),#文件上传库路径
    # path(r'^upload',views.back),#文件下载
]
