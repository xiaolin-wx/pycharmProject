...
| -------------- | -------------------------------- | ---------------------------------------- |
| deploy_vel     | Dehaze model based on TensorFlow | Download the model file and the corresponding CFG file by referring to "[Original Model](https://gitee.com/ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/dehaze/ATC_deploy_vel_tf_AE)". |
