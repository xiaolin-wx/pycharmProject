...
2.  运行应用
    ...
    4.  在vpc_jpeg_resnet50_imagenet_classification路径下请用户根据场景选择对应的命令执行：
        执行解码+缩放+推理：
        ```
        python3 main.py --images_path="./data/wood_rabbit_1024_1061_330.jpg" --dvpp_type=0 --image_type='jpg'
        ```
        执行抠图：
        ```
        python3 main.py --images_path="./data/wood_rabbit_1024_1068_nv12.yuv" --dvpp_type=1 --image_type='yuv'
        ```
        执行抠图粘贴：
        ```
        python3 main.py --images_path="./data/wood_rabbit_1024_1068_nv12.yuv" --dvpp_type=2 --image_type='yuv'
        ```
        执行编码：
        ```
        python3 main.py --images_path="./data/wood_rabbit_1024_1068_nv12.yuv" --dvpp_type=3 --image_type='yuv'
        ```
        8k缩放：
        ```
        python3 main.py --images_path="./data/dvpp_vpc_8192_8192_nv12.yuv" --dvpp_type=4 --image_type='yuv'
        ```
        执行批量抠图：
        ```
        python3 main.py --images_path="./data/wood_rabbit_1024_1068_nv12.yuv" --dvpp_type=5 --image_type='yuv' --in_batch_size=1 --out_batch_size=8
        ```
        执行批量抠图粘贴：
        ```
        python3 main.py --images_path="./data/wood_rabbit_1024_1068_nv12.yuv" --dvpp_type=6 --image_type='yuv' --in_batch_size=1 --out_batch_size=8
        ```
