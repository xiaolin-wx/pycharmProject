...
3. 将原始模型转换为Davinci模型。
    ...
    **注：请确认环境变量已经在[环境准备和依赖安装](../../../environment)中配置完成**
    ...
    2. 执行以下atc命令进行模型转换。
        ...
        **cd $HOME/models/YOLOV3_mask_detection_video**  
