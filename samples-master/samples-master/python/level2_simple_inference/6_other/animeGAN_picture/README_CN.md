...
2. 获取此应用中所需要Davinci模型。
    1. 参考下方链接获取此应用中所用到的原始网络模型。
        ...
        **cd $HOME/samples/python/level2_simple_inference/6_other/animeGAN_picture/model** 。   
        ...
        | **模型名称** | **模型说明**                   | **模型下载路径**                                             |
        | ------------ | ------------------------------ | ------------------------------------------------------------ |
        | AnimeGAN | 将普通照片转换为卡通风格的图片。 | 请参考https://gitee.com/ascend/modelzoo/tree/2f3fda4af5da9dbc4329d2d93bc0832d17e12c86/contrib/TensorFlow/Research/cv/AnimeGAN 下载原始模型。 |
