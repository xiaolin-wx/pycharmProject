...
2. 获取此应用中所需要的原始网络模型。
    ...
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  EDVR | 视频进行超分辨率推理模型。是基于Tensorflow的EDVR模型。  |  请参考[https://gitee.com/ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/video_super_resolution/ATC_EDVR_tf_AE/](https://gitee.com/ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/video_super_resolution/ATC_EDVR_tf_AE/)目录中README.md下载原始模型章节下载模型和权重文件。 |
