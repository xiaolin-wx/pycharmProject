...
| **模型名称** | **模型说明**                                | **模型下载路径**                                             |
| ------------ | ------------------------------------------- | ------------------------------------------------------------ |
| vgg16        | 基于TensorFlow的VGG16模型，用于猫狗分类。 | 请参考https://gitee.com/ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/classification_cat_dog/ATC_VGG16_tf_AE 中README.md原始模型章节，下载**原始模型**及**对应的cfg文件**。 |
