...
2. 获取此应用中所需要的原始网络模型。
    ...
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    | vessel | 图片分割模型。是基于Caffe的vessel_segmentation模型。 | 请参考[https://gitee.com/ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/vessel-segmentation/ATC_retina-unet_caffe_AE](https://gitee.com/ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/vessel-segmentation/ATC_retina-unet_caffe_AE)目录中README.md下载原始模型章节下载模型和权重文件。 |
